...
export default function BookSessionPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 p-6 relative">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Book a Session</h1>
          <p className="text-slate-600">Choose your therapist and schedule your appointment</p>
          
          {/* Show selected therapist prominently */}
          {selectedTherapist && (
            <div className="mt-6 p-6 bg-gradient-to-r from-indigo-50 to-pink-50 rounded-xl border border-indigo-200 shadow-lg">
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-left">
                  <h2 className="text-2xl font-bold text-indigo-700">{selectedTherapist.name}</h2>
                  <p className="text-lg text-indigo-600 font-medium">{selectedTherapist.specialization}</p>
                  <p className="text-sm text-slate-500">Licensed Professional</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <Input
                      ...
                      required
                      className="h-12 text-lg bg-white border-slate-200 focus:border-indigo-500 focus:ring-indigo-500"
                    />
                    
                    {date && (
                      <div className="p-4 bg-gradient-to-r from-indigo-50 to-pink-50 rounded-lg border border-indigo-200">
