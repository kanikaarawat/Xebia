                        ...
                        <SelectItem key={therapist.id} value={therapist.id} className="hover:bg-slate-100">
                          <div className="flex items-center space-x-2 sm:space-x-3 py-2 sm:py-3">
                            <Avatar className="w-8 h-8 sm:w-12 sm:h-12">
                              ...
                              <AvatarFallback className="bg-gradient-to-br from-pink-400 to-indigo-400 text-white text-xs sm:text-sm">
                                {therapist.name.split(' ').map(n => n[0]).join('')}
                              </AvatarFallback>
                            </Avatar>
                            <div className="flex-1 min-w-0">
                              <div className="font-semibold text-slate-700 text-sm sm:text-base truncate">{therapist.name}</div>
                              <div className="text-xs sm:text-sm text-indigo-600 font-medium truncate">{therapist.specialization}</div>
